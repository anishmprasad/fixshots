...
const TouchableRoundedImage = ({ style, ...props }) => (
	<TouchableOpacity style={style}>
		<ImageBackground borderRadius={6} style={styles.touchableRoundedImage} {...props} />
	</TouchableOpacity>
);
const recents = [
	{
...
export class ShowcaseScreen extends React.Component {
	static navigationOptions = ({ navigation }) => ({
		headerLeft: (
			<TouchableOpacity style={headerStyles.backTouchable} onPress={() => navigation.navigate('DrawerOpen')}>
		...
		return (
			<View style={styles.screenContainer}>
				...
				<View style={styles.header}>
					...
					<TouchableOpacity>
						<Image style={styles.avatar} source={require('../../assets/2957332499138.jpg')} />
					</TouchableOpacity>
				</View>
